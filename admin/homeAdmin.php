...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">SHOTS</span>
    </a>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">SEÑOR ADMINISTRADOR</h5>

                <p class="card-text">
                  PODRÁ REGISTRAR, CONSULTAR, MODIFICAR Y/O ELIMINAR PRODUCTOS, USUARIOS, PEDIDOS, VENTAS; ADEMÁS PODRÁ GENERAR REPORTES DE CADA UNO DE LOS YA MENCIONADOS
                </p>
