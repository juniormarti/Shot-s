  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">REGISTRAR VENTAS DEL ADMINISTRADOR</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            ...
            <div class="card card-dark">
              ...
              <form action="../../controller/insertarVentaAdmin.php" method="POST"> 
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="number" class="form-control" name="cantidad" id="exampleInputEmail1" placeholder="Ej: 20">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="exampleInputEmail1">Valor Unitario</label>
                      <input type="number" name="valorUnitario" class="form-control" id="exampleInputEmail1" placeholder="Ej: 25000">
                    </div>
                    <div class="form-group col-md-6">
                      <label for="exampleInputEmail1">Ubicacion del Producto</label>
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="number" name="valorTotal" class="form-control" id="exampleInputEmail1" placeholder="Ej: 100000">
                    </div>
