  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">REGISTRAR PRODUCTOS EN EL SISTEMA</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            ...
            <div class="card card-dark">
              ...
              <form action="../../controller/insertarProductoAdmin.php" method="POST"> 
                <div class="card-body">
                  <div class="row">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <input type="number" name="precioUnitario" class="form-control" id="exampleInputEmail1" placeholder="Ej: 25000">
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <select class="form-control select2" name="proveedor" style="width: 100%;">
                          ...
                          <option value="bavaria">Bavaria S.A</option>
                      </select>
                    </div>
                  </div>
