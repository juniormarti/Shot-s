...
<?php
    ...
    require_once("../../controller/mostrarVentasAdmin.php");
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">VENTAS REGISTRADOS EN EL SISTEMA</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-lg-12">
            ...
            <div class="card card-dark">
              <div class="card-header">
                <h5 class="m-0">Seleccione la Venta a modificar o eliminar</h5>
              </div>
              <div class="card-body">
